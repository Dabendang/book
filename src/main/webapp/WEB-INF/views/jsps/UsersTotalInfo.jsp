...
<div class="container">
    <div class="row">
        <h1 class="text-primary">总 用 户 信 息</h1>
    </div>
    <div class="row">
        <table class="table table-hover">
            <thead>
            <th>总人数</th>
            <td>${UsersInfo.totalNum}</td>
            </thead>
            <tbody>
            <tr>
                <th>会员人数</th>
                <td>${UsersInfo.vipNum}</td>
            </tr>
            <tr>
                <th>非会员人数</th>
                <td>${UsersInfo.normalNum}</td>
            </tr>
            <tr>
                <th>男性人数</th>
                <td>${UsersInfo.manNum}</td>
            </tr>
            <tr>
                <th>女性人数</th>
                <td>${UsersInfo.womanNum}</td>
            </tr>
            </tbody>
        </table>
    </div>
    <div class="row">
        <div class="col-md-offset-8">
            <a  class="btn btn-primary" href="${ctx}/backend/admin/getAllUserInfo">
